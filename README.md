...
* Settings > Add-ons > Plus > Repositories > Add `https://github.com/djvabe/hassio-add-ons`
...
```
    ...
    services:
      broadlinkac2mqtt:
        image: "ghcr.io/djvabe/broadlinkac2mqtt:latest"
...
```
   docker run -d --name="broadlinkac2mqtt" -v /PATH_TO_YOUR_CONFIG:/config --restart always ghcr.io/djvabe/broadlinkac2mqtt:latest   
```
...
> [@cHunter789](https://github.com/djvabe/broadlinkac2mqtt/issues/6#issuecomment-2308999367) wrote:
>
